...
exports.SignInPageNew = class SignInPageNew {
    constructor(page) {
        ...
        this.signin_stoneberrycredit_button = page.getByRole('link', { name: signinpage_locator.signin_stoneberrycredit_button });
        this.signin_makeapayment_button = page.getByRole('link', { name: signinpage_locator.signin_makeapayment_button });
